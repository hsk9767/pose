...
def main():
    ...
    pose_fix.init_weight('output/coco/pose_resnet_50/for_train_pose_fix/2021-02-17-00-00/model_best.pth')
    ...
    validate(config, valid_loader, valid_dataset, model, pose_fix, criterion,
